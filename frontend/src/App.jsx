...
export default function App() {
  ...
  const [formType, setFormType] = useState("Right to Information (RTI) Application [Sec 6(1) RTI Act 2005]");
  ...
  const [triageDetails, setTriageDetails] = useState({
    category: "Consumer Defect & Service Deficiency (E-commerce, Electronics, Airlines, Banking)",
    jurisdiction: "",
    opposingParty: "",
  ...
  const handleGenerateForm = async (e) => {
    e.preventDefault();
    if (!formDetails.applicantName || !formDetails.targetAuthority || !formDetails.reliefSought) {
      alert("Please fill in Applicant Name, Target Department/Opposite Party, and Specific Information/Remedy.");
      return;
    }
      ...
      const res = await fetch("http://localhost:8000/api/generate-form", {
        ...
        body: JSON.stringify({
          ...
          details: {
            ...
            "Additional Context & Reference Numbers": formDetails.additionalNotes,
          }
        })
      });
      if (res.ok) {
  ...
  const handleRunTriage = async (e) => {
    e.preventDefault();
    if (!triageDetails.description || triageDetails.description.trim().length < 15) {
      alert("Please provide a narrative description of at least 15 characters.");
      return;
    }
    ...
    <div className="app-wrapper">
      ...
      <header className="app-header">
        <div className="header-info">
          ...
          <p className="header-subtitle">Civic & Legal Empowerment AI Assistant • Powered by Mistral 7B & FAISS RAG</p>
        </div>
            ...
            <div className="left-pane" style={{ overflowY: "auto" }}>
              <form className="form-container" onSubmit={handleGenerateForm}>
                <div className="form-title-bar">
                  <h3 className="form-title">📝 Conversational Legal Drafter</h3>
                  <p className="form-subtitle">Create standardized legal notices and RTI applications. Fill details below and AI will format it correctly.</p>
                </div>
                ...
                <div className="form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setFormDetails(prev => ({ ...prev, applicantName: e.target.value }))}
                    required
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <textarea 
                    ...
                    onChange={(e) => setFormDetails(prev => ({ ...prev, applicantAddress: e.target.value }))}
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setFormDetails(prev => ({ ...prev, targetAuthority: e.target.value }))}
                    required
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setFormDetails(prev => ({ ...prev, incidentDate: e.target.value }))}
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <textarea 
                    ...
                    onChange={(e) => setFormDetails(prev => ({ ...prev, reliefSought: e.target.value }))}
                    required
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <textarea 
                    ...
                    onChange={(e) => setFormDetails(prev => ({ ...prev, additionalNotes: e.target.value }))}
                  />
                </div>
                ...
                >
                  {formGenerating ? (
                    <>
                      <Loader2 size={16} className="animate-spin" /> Drafting Application...
                    </>
                  ) : (
                    <>
            ...
            <div className="right-pane">
              ...
              {generatedForm ? (
                <div className="plaintext-output-container">
                  ...
                  <div className="action-bar">
                    <button 
                      ...
                      onClick={() => handleCopyText(generatedForm, setFormCopied)}
                    >
                    ...
                    <button 
                      ...
                      onClick={() => handleDownloadTxt(generatedForm, `${formType.slice(0, 15).replace(/\s+/g, '_')}_Application.txt`)}
                    >
                ...
                <div style={{
                  ...
                  <p style={{ color: "#94a3b8", fontSize: "0.95rem", maxWidth: "400px", lineHeight: 1.6, margin: "0 0 20px 0" }}>
                    Fill out the applicant details, date timeline, opposing party, and remedy requested in the left panel. SAMA-VIDHANA will generate a formatted, ready-to-copy plaintext application according to Indian statutory rules.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="left-pane" style={{ overflowY: "auto" }}>
              <div className="form-container">
                <div className="form-title-bar">
                  ...
                  <p className="form-subtitle">Search for central and state government schemes matching your profile and household needs.</p>
                </div>
                ...
                <div className="form-group">
                  ...
                  <select 
                    ...
                    onChange={(e) => setCitizenProfile(prev => ({ ...prev, category: e.target.value }))}
                  >
                    <option value="All Categories">All Categories</option>
                    <option value="Agriculture & Farmers">Agriculture & Farmers</option>
                    <option value="Healthcare & Social Security">Healthcare & Social Security</option>
                    ...
                    <option value="Micro-Enterprise & Self Employment">Micro-Enterprise & Self Employment</option>
                    <option value="Senior Citizens & Social Welfare">Senior Citizens & Social Welfare</option>
                    <option value="Artisans & Traditional Craftspeople">Artisans & Traditional Craftspeople</option>
                  </select>
                </div>
                ...
                <div className="form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setCitizenProfile(prev => ({ ...prev, age: parseInt(e.target.value) || 35 }))}
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <select 
                    ...
                    onChange={(e) => setCitizenProfile(prev => ({ ...prev, income: e.target.value }))}
                  >
                    <option value="< ₹1,00,000 (BPL / Deprived)">&lt; ₹1,00,000 (BPL / Deprived)</option>
                    <option value="₹1,00,000 - ₹3,00,000 (EWS)">₹1,00,000 - ₹3,00,000 (EWS)</option>
                    <option value="₹3,00,000 - ₹6,00,000 (LIG)">₹3,00,000 - ₹6,00,000 (LIG)</option>
                    <option value="> ₹6,00,000 (MIG/General)">&gt; ₹6,00,000 (MIG/General)</option>
                  </select>
                </div>
                ...
                <div className="form-group">
                  ...
                  <select 
                    ...
                    onChange={(e) => setCitizenProfile(prev => ({ ...prev, occupation: e.target.value }))}
                  >
                    <option value="Small / Marginal Farmer">Small / Marginal Farmer</option>
                    <option value="Daily Wage / Unorganized Worker">Daily Wage / Unorganized Worker</option>
                    ...
                    <option value="Homemaker / Mother">Homemaker / Mother</option>
                ...
                <div className="suggestions-box" style={{ padding: 0 }}>
                  <button 
                    ...
                    className="suggestion-chip"
                    onClick={() => {
                      setSchemeQuery("Direct cash transfer income support for farmers");
                    }}
                  >
                  ...
                  <button 
                    ...
                    className="suggestion-chip"
                    onClick={() => {
                      setSchemeQuery("Ayushman Bharat cashless health insurance coverage");
                    }}
                  >
                  ...
                  <button 
                    ...
                    className="suggestion-chip"
                    onClick={() => {
                      setSchemeQuery("PM Vishwakarma toolkits and collateral free loan for artisans");
                    }}
                  >
                ...
                >
                  {schemesLoading ? (
                    <>
                      <Loader2 size={16} className="animate-spin" /> Searching Database...
                    </>
                  ) : (
                    <>
            ...
            <div className="right-pane">
              ...
              {matchedSchemes.length > 0 ? (
                <div className="schemes-list-container">
                  <h2 style={{ margin: "0 0 10px 0", fontSize: "1.20rem", fontWeight: 800, color: "#f8fafc" }}>
                    ...
                    <div key={i} className="scheme-card-item">
                      <div className="scheme-card-header">
                        ...
                        <div className="scheme-card-meta">
                          Category: <strong>{sch.category}</strong> | Ministry: <strong>{sch.ministry}</strong>
                        </div>
                      </div>
                ...
                <div style={{
                  ...
                  <p style={{ color: "#94a3b8", fontSize: "0.95rem", maxWidth: "400px", lineHeight: 1.6, margin: "0 0 20px 0" }}>
                    Set up your citizen profile variables on the left, or search for a specific need. SAMA-VIDHANA indexes major Indian Welfare Schemes (like PM-KISAN, Ayushman Bharat, PMAY, Sukanya Samriddhi) to find the best match.
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="app-container" style={{ width: "100%", height: "100%" }}>
            ...
            <div className="left-pane" style={{ overflowY: "auto" }}>
              <form className="form-container" onSubmit={handleRunTriage}>
                <div className="form-title-bar">
                  <h3 className="form-title">🧭 Legal Routing & Dispute Intake</h3>
                  <p className="form-subtitle">Analyze a legal conflict, evaluate deadlines/limitations, and find the appropriate ombudsman or commission.</p>
                </div>
                ...
                <div className="form-group">
                  ...
                  <select 
                    ...
                    onChange={(e) => setTriageDetails(prev => ({ ...prev, category: e.target.value }))}
                  >
                ...
                <div className="form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setTriageDetails(prev => ({ ...prev, jurisdiction: e.target.value }))}
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setTriageDetails(prev => ({ ...prev, opposingParty: e.target.value }))}
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <select 
                    ...
                    onChange={(e) => setTriageDetails(prev => ({ ...prev, status: e.target.value }))}
                  >
                ...
                <div className="form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setTriageDetails(prev => ({ ...prev, documents: e.target.value }))}
                  />
                </div>

                <div className="form-group">
                  <label>Detailed Incident Narrative (What happened? financial loss?)</label>
                  <textarea 
                    className="form-textarea" 
                    ...
                    onChange={(e) => setTriageDetails(prev => ({ ...prev, description: e.target.value }))}
                ...
                >
                  {triageLoading ? (
                    <>
                      <Loader2 size={16} className="animate-spin" /> Analyzing Situation...
                    </>
                  ) : (
                    <>
              ...
              {triageReport ? (
                <div className="triage-roadmap-container">
                  ...
                  <div className="triage-roadmap-content">
                    ...
                    {triageReport.split("\n").map((line, idx) => {
                      if (line.startsWith("###")) {
                        return <h4 key={idx} style={{ color: "#38bdf8", marginTop: 12, marginBottom: 6, fontSize: "1rem" }}>{line.replace("###", "").trim()}</h4>;
                      } else if (line.startsWith("##")) {
                        return <h3 key={idx} style={{ color: "#818cf8", marginTop: 16, marginBottom: 8, fontSize: "1.1rem" }}>{line.replace("##", "").trim()}</h3>;
                      } else if (line.startsWith("#")) {
                        return <h2 key={idx} style={{ color: "#c084fc", marginTop: 20, marginBottom: 10, fontSize: "1.25rem" }}>{line.replace("#", "").trim()}</h2>;
                      } else if (line.trim().startsWith("-") || line.trim().startsWith("*")) {
                        const text = line.trim().replace(/^[-*]\s+/, "");
                        const parts = text.split("**");
                        return (
                          <li key={idx} style={{ marginLeft: 15, listStyleType: "disc" }}>
                            {parts.map((part, pIdx) => pIdx % 2 === 1 ? <strong key={pIdx}>{part}</strong> : part)}
                          </li>
                        );
                      } else if (line.trim()) {
                  ...
                  <div className="action-bar">
                    <button 
                      className="btn-action primary"
                      onClick={() => handleCopyText(triageReport, setTriageCopied)}
                    >
                    ...
                    <button 
                      className="btn-action"
                      onClick={() => handleDownloadTxt(triageReport, "SAMA_VIDHANA_Legal_Triage_Roadmap.txt")}
                    >
                ...
                <div style={{
                  ...
                  <p style={{ color: "#94a3b8", fontSize: "0.95rem", maxWidth: "400px", lineHeight: 1.6, margin: "0 0 20px 0" }}>
                    Input details of your dispute (category, location, evidence, and narrative description) on the left panel. SAMA-VIDHANA will analyze the situation and generate an actionable triage roadmap covering statutory deadlines, forums of jurisdiction, and procedural steps.
                  </p>
                </div>
              )}
            </div>
